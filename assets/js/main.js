...
function finalVideo() {
    // Video selesai, mengubah ikon
    videoIcon.classList.remove('bx-pause');
    videoIcon.classList.add('bx-play');
}

// Sembunyikan layar loading ketika video siap diputar
videoFile.addEventListener('canplaythrough', function () {
    loadingScreen.style.display = 'none';
});

// Saat video selesai, mengubah ikon
